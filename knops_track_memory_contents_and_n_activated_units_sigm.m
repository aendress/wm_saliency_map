function [mean_activation, faithfulness, activation_in_early_and_late_targets, inhibition_sum, n_active_neurons, mean_activation_in_active_neurons, dprime, bbeta] = knops_track_memory_contents_and_n_activated_units_sigm(sequentialPresentation, letNetworkSettleDuringSequentialPresentation, b_arg, useDist, snoise_arg,  activation_threshold_arg, total_time_steps_arg)
