function [mean_activation, faithfulness, activation_in_early_and_late_targets, inhibition_sum, n_active_neurons, mean_activation_in_active_neurons, dprime, bbeta] = knops_track_memory_contents_and_number_of_activated_units(sequentialPresentation, letNetworkSettleDuringSequentialPresentation, b_arg, useDist, snoise_arg,  activation_threshold_arg, total_time_steps_arg)
...
% * 
    ...
    function [mean_activation, faithfulness, activation_in_early_and_late_targets, inhibition_sum, n_active_neurons, mean_activation_in_active_neurons, dprime, bbeta] = run_simulation_track_number(set_size, dist, useDist, sequentialPresentation, letNetworkSettleDuringSequentialPresentation, nsim)
    % [mean_activation, faithfulness, activation_in_early_and_late_targets, inhibition_sum, 
    %    n_active_neurons, mean_activation_in_active_neurons, dprime, bbeta] = 
    % run_simulation_track_number(set_size, dist, useDist, sequentialPresentation, 
...
%for ss=1:70
    ...
    [ma, ff, act_el_targets, inhib, n_active, ma_in_active, dprm, bbta] = run_simulation_track_number(ss, dist, useDist, sequentialPresentation, letNetworkSettleDuringSequentialPresentation);   
